classdef gridOptimiser < handle
    ...
    methods
        ...
        function [optCoord, L_peak] = fmincon(~, objective_to_minimise, extra_args, lb, ub, grid_points)
            ...
            for i = 1:size(initial_guesses, 1)
                ...
                % Define the objective function for fmincon (negative of the function to maximize)
